...
public class ItemAnimation {
    ...
    /* animation duration */
    private static final long DURATION_IN_BOTTOM_UP = 500;
    private static final long DURATION_IN_FADE_ID = 1000;
    private static final long DURATION_IN_LEFT_RIGHT = 150;
    private static final long DURATION_IN_RIGHT_LEFT = 500;
